...
public class EventSeries implements Serializable {
     ...
     */
    public EventSeries(String name, LocalDateTime startDateTime, LocalDateTime endDateTime, String seriesName, Duration
            duration, int number) {
    ...
    /**
     * This method removes a given event from the series
    ...
    /**
     * This method edits the name of this series
     * @param text new name of the series in String
     */
    public void changeNameTo(String text) {
